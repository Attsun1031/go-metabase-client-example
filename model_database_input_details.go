...
// checks if the DatabaseInputDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseInputDetails{}
...
func (o DatabaseInputDetails) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseInputDetails struct {
	value *DatabaseInputDetails
	isSet bool
}

func (v NullableDatabaseInputDetails) Get() *DatabaseInputDetails {
	return v.value
}

func (v *NullableDatabaseInputDetails) Set(val *DatabaseInputDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseInputDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseInputDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseInputDetails(val *DatabaseInputDetails) *NullableDatabaseInputDetails {
	return &NullableDatabaseInputDetails{value: val, isSet: true}
}

func (v NullableDatabaseInputDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseInputDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
