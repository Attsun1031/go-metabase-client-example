...
*/
func (a *GroupApiService) DeleteGroup(ctx context.Context, id int64) ApiDeleteGroupRequest {
	return ApiDeleteGroupRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *GroupApiService) DeleteGroupExecute(r ApiDeleteGroupRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/group/{id}"
...
func (a *GroupApiService) GetGroupExecute(r ApiGetGroupRequest) (*GroupWithMembers, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GroupWithMembers
	)
...
func (r ApiUpdateGroupRequest) Execute() (*GroupUpdateResponse, *http.Response, error) {
...
*/
func (a *GroupApiService) UpdateGroup(ctx context.Context, id int64) ApiUpdateGroupRequest {
	return ApiUpdateGroupRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *GroupApiService) UpdateGroupExecute(r ApiUpdateGroupRequest) (*GroupUpdateResponse, *http.Response, error) {
	var (
